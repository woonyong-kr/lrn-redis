...
85개 필수 Python 검증, Redis 7.4.9의 53개 대표 정상 명령과 차등 비교. 분할 입력·잘못된 인수·느린 TCP client·AOF 손상·snapshot 다중 자료형·fsync·퇴출 후 복구를 포함한다. 차등 비교는 전체 문법 호환성 검증이 아니다.
...
과거 문서·실험·기여 기록은 [정리 전 이력](https://github.com/woonyong-kr/lrn-redis/tree/4ade14e1ec3ec2072d1ae9b7940946652bfb905e)에서 확인할 수 있다. 실행법과 지원 계약은 이 README에 모았다. 개념·설계·실험 해석 자료는 개인 WIKI inbox에서 검토한 뒤 기존 정본에 흡수한다.
